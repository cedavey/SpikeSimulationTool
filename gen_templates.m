...
templates.parametersUsed = store(const, templates);
...
for i = max_sr_refract_time + templates.initial_ap:1/max_sampling_rate * 1000:duration
    ...
    if (i > max_sr_refract_time + templates.initial_ap + 6)...
...
function parametersUsed = store(const, templates)

parametersUsed = {};

parametersUsed{1} = {['Sampling rate = ' num2str(templates.sampling_rate)]};
parametersUsed{2} = {['eNa = ' num2str(const.eNa - const.vRest)] ['gNa = ' num2str(const.gNa)]};
parametersUsed{3} = {['eK = ' num2str(const.eK - const.vRest)] ['gK = ' num2str(const.gK)]};
parametersUsed{4} = {['eLeak = ' num2str(const.eLeak - const.vRest)] ['gLeak = ' num2str(const.gLeak)]};
parametersUsed{5} = {['C = ' num2str(const.C)]};
parametersUsed{6} = {['vRest = ' num2str(const.vRest)]};
